import React, { memo, useCallback, ChangeEvent, ComponentType } from 'react';
...
interface IProps {
  ...
  placeholder: string;
  isLoading?: boolean;
  CustomIcon?: ComponentType<IIconProps>;
...
export const MobileSelectInputMemo = memo(
  MobileSelectInput
) as typeof MobileSelectInput;
